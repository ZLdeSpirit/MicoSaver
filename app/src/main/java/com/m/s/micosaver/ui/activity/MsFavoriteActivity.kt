...
class MsFavoriteActivity : BaseActivity() {
    private val mBinding by lazy { MsActivityVideoBinding.inflate(layoutInflater) }
    ...
    override fun onInitView() {
        ...
        mBinding.apply {
            ...
            bottomShareLl.setOnClickListener {
            ...
            recyclerView.layoutManager = GridLayoutManager(this@MsFavoriteActivity, 3)
    ...
    private fun loadData() {
        scope.launch {
            val dataList = MsDataBase.database.savedVideoDao().getLikedVideos()
